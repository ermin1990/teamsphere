...
class CompetitionMatchResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'home_player' => $this->whenLoaded('homePlayer', fn () => $this->homePlayer ? new PlayerResource($this->homePlayer) : null),
            'away_player' => $this->whenLoaded('awayPlayer', fn () => $this->awayPlayer ? new PlayerResource($this->awayPlayer) : null),
            'home_team' => $this->whenLoaded('homeTeam', fn () => $this->homeTeam ? new TeamResource($this->homeTeam) : null),
            'away_team' => $this->whenLoaded('awayTeam', fn () => $this->awayTeam ? new TeamResource($this->awayTeam) : null),
