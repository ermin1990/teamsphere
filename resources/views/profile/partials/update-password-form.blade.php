<section>
    <header>
        ...
        <p class="mt-1 text-sm" style="color: var(--text-tertiary);">
            Osigurajte da vaš nalog koristi dugu, nasumičnu lozinku da bi bio siguran.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="'Potvrdite Lozinku'" />
