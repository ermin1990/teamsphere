...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
    <div class="bg-gray-800/50 backdrop-blur-xl rounded-xl p-3 border border-gray-700/50">
    ...
    <div class="bg-gray-800/50 backdrop-blur-xl rounded-xl p-3 border border-gray-700/50">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white text-base font-bold mt-1">{{ $competition->is_team_based ? 'Tim' : 'Individualno' }}</p>
            </div>
    ...
    <div class="bg-gray-800/50 backdrop-blur-xl rounded-xl p-3 border border-gray-700/50">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white text-base font-bold mt-1">{{ $competition->start_date->format('M d, Y') }}</p>
            </div>
            <div class="w-8 h-8 bg-yellow-600/20 rounded-lg flex items-center justify-center flex-shrink-0">
