    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-wrap gap-3">
                ...
                <form method="POST" action="{{ route('organizations.competitions.update', [$organization, $competition]) }}" class="inline-flex items-center space-x-2">
                    @csrf
                    @method('PATCH')
                    <label class="flex items-center space-x-2 cursor-pointer">
                        <span class="text-white text-sm font-medium">{{ __('Public') }}</span>
                        <input type="checkbox" 
                               name="is_public" 
                               value="1" 
