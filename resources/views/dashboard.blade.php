                                    ...
                                    @if($organization->user_id === Auth::id())
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            ...
                                            @if($organization->canCreateMoreCompetitions())
                                                <a href="{{ route('organizations.competitions.create', $organization) }}" class="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-3 py-2 rounded-lg transition-all duration-200 text-center text-sm font-semibold">
                                                    <span class="flex items-center justify-center space-x-1">
                                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                                        </svg>
