...
@if($isIndividualMatch)
    ...
    <div class="space-y-4">
        ...
        <div id="sets-breakdown" class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-4 md:p-6 border border-gray-700/50 shadow-xl">
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-4 md:p-6 border border-gray-700/50 shadow-xl text-center">
            ...
            <div class="text-white text-xs">Auto-refreshing every 3 seconds</div>
            <div id="last-updated-time" class="text-xs text-gray-500 mt-1">
