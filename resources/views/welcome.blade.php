        ...
        <section id="features" class="py-32 relative">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <!-- Feature 1 -->
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-gray-600/50 transition-all">
                    ...
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-gray-600/50 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-4">{{ __('messages.features.items.scheduling.title') }}</h3>
                        <p class="text-gray-400 leading-relaxed">
                            {{ __('messages.features.items.scheduling.description') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-gray-600/50 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-4">{{ __('messages.features.items.communication.title') }}</h3>
                        <p class="text-gray-400 leading-relaxed">
                            {{ __('messages.features.items.communication.description') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-gray-600/50 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-4">{{ __('messages.features.items.mobile.title') }}</h3>
                        <p class="text-gray-400 leading-relaxed">
                            {{ __('messages.features.items.mobile.description') }}
                        </p>
                    </div>
                </div>
            </div>
