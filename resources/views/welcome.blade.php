...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-900 text-white">
        <!-- Navigation -->
        <nav class="fixed top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-700/50">
        ...
        <section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 text-center">
                <!-- Badge -->
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
                    ...
                    @endif
                    <a href="#demo" class="border border-gray-600 hover:border-gray-500 px-8 py-4 rounded-xl text-gray-300 hover:text-white font-semibold text-lg transition-all">
                        <span class="flex items-center space-x-2">
        ...
        <section id="features" class="py-32 relative">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8">
                ...
                <div class="text-center mb-20">
                    <div class="inline-flex items-center space-x-2 bg-purple-500/10 border border-purple-500/20 rounded-full px-6 py-3 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105 group">
                        <div class="w-12 h-12 bg-blue-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-blue-500/30 transition-colors">
                    ...
                    <!-- Feature 2: League Organization -->
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-emerald-500/50 transition-all duration-300 hover:transform hover:scale-105 group">
                        <div class="w-12 h-12 bg-emerald-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-emerald-500/30 transition-colors">
                    ...
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105 group">
                        <div class="w-12 h-12 bg-purple-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-purple-500/30 transition-colors">
                    ...
                    <!-- Feature 4: Match Scheduling -->
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-pink-500/50 transition-all duration-300 hover:transform hover:scale-105 group">
                        <div class="w-12 h-12 bg-pink-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-pink-500/30 transition-colors">
                            <svg class="w-6 h-6 text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            </svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-4">Smart Match Scheduling</h3>
                        <p class="text-gray-400 leading-relaxed">
                            Automatically schedule matches, send notifications, and manage venue bookings with intelligent conflict resolution.
                        </p>
                    </div>

                    <!-- Feature 5: Player Performance Tracking -->
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105 group">
                        <div class="w-12 h-12 bg-orange-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-orange-500/30 transition-colors">
                            <svg class="w-6 h-6 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                            </svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-4">Player Performance Tracking</h3>
                        <p class="text-gray-400 leading-relaxed">
                            Track individual player statistics, performance metrics, and improvement trends with detailed analytics and insights.
                        </p>
                    </div>

                    <!-- Feature 6: Multi-Sport Support -->
                    <div class="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 group">
                        <div class="w-12 h-12 bg-cyan-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-cyan-500/30 transition-colors">
                            <svg class="w-6 h-6 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064"></path>
                            </svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-4">Multi-Sport Support</h3>
                        <p class="text-gray-400 leading-relaxed">
                            Support for football, basketball, tennis, volleyball, and many other sports with sport-specific rules and scoring systems.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section id="how-it-works" class="py-32 relative">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8">
                <div class="text-center mb-20">
                    <div class="inline-flex items-center space-x-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-6 py-3 mb-8">
        ...
        <section id="demo" class="py-32 relative">
            <div class="absolute inset-0 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900"></div>
            <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 text-center">
                <div class="inline-flex items-center space-x-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full px-6 py-3 mb-8">
                ...
                <!-- Demo Placeholder -->
                <div class="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-12 max-w-4xl mx-auto border border-gray-700/50">
                    <div class="aspect-video bg-gray-800/50 rounded-xl flex items-center justify-center border border-gray-700/50">
                        <div class="text-center">
        ...
        <section class="py-32 relative">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8">
                <div class="text-center mb-16">
                    <div class="inline-flex items-center space-x-2 bg-green-500/10 border border-green-500/20 rounded-full px-6 py-3 mb-8">
