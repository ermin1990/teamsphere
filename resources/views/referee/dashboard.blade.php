        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Sudijska Kontrolna Tabla</h1>
                        <p class="mt-1 text-sm text-gray-500">Upravljajte mečevima i rezultatima za vaše dodijeljene lige</p>
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Moje Lige</dt>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Završeni Mečevi</dt>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Zakazani</dt>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md mb-8">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Moje Organizacije</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Organizacije gdje ste dodijeljeni kao sudija</p>
            </div>
            <ul class="divide-y divide-gray-200">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">{{ $organization->leagues->count() }} Lige • {{ $organization->leagues->sum(function($league) { return $league->matches->count(); }) }} Mečevi</div>
                                        </div>
                                    </div>
                                    <div class="flex items-center">
                ...
                @empty
                    <li class="px-4 py-8 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">Još nema organizacija</h3>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md mb-8">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Moje Lige</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Lige gdje ste dodijeljeni kao sudija</p>
            </div>
            <ul class="divide-y divide-gray-200">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">{{ $league->organization->name }} • {{ $league->matches->count() }} Mečevi</div>
                                        </div>
                                    </div>
                                    <div class="flex items-center">
                                        <svg class="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                @empty
                    <li class="px-4 py-8 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">Još nema liga</h3>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Nedavni Mečevi</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Mečevi zakazani u posljednjih 7 dana</p>
            </div>
            <ul class="divide-y divide-gray-200">
                ...
                @empty
                    <li class="px-4 py-8 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">Nema nedavnih mečeva</h3>
                        <p class="mt-1 text-sm text-gray-500">Nema mečeva zakazanih u posljednjih 7 dana</p>
                    </li>
                @endforelse
            </ul>
        </div>
