        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Moje Lige</h1>
                        <p class="mt-1 text-sm text-gray-500">Lige gdje ste dodijeljeni kao sudija</p>
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3 mb-6">
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-500">Ukupno Mečeva:</span>
                                ...
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-500">Zakazani:</span>
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">Nema dodijeljenih liga</h3>
