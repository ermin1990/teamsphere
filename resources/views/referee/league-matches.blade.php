    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Matches</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">All matches in this league</p>
            </div>
                ...
                @foreach($matches as $round => $roundMatches)
                    <div class="border-b border-gray-200 last:border-b-0">
                        <div class="px-4 py-3 sm:px-6 bg-gray-50">
                            <h4 class="text-sm font-medium text-gray-900">Round {{ $round }}</h4>
                        </div>
            ...
            @else
                <div class="px-4 py-8 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">This league doesn't have any matches yet.</p>
                </div>
            @endif
        </div>
    </div>
