                ...
                @if($currentGroupMatches->count() > 0)
                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="grid grid-cols-12 gap-2 items-center py-2 px-2 {{ $index < $advancingPlayers ? 'bg-green-900/30 dark:bg-green-900/30 light:bg-green-100/50' : 'bg-[var(--bg-tertiary)]' }} hover:bg-[var(--bg-secondary)] rounded text-xs md:text-sm transition-all duration-200">
                                ...
                                <div class="col-span-1 text-center">
                                    <span class="text-green-600 dark:text-gray-300 light:text-green-700 font-bold">{{ $standing->won ?? 0 }}</span>
                                </div>
                               
                                <div class="col-span-1 text-center">
                                    <span class="text-red-600 dark:text-red-400 light:text-red-600 font-bold">{{ $standing->lost ?? 0 }}</span>
                                </div>
                                <div class="col-span-1 text-center">
