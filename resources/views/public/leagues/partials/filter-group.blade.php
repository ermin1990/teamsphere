...
<div class="flex flex-wrap lg:flex-col gap-1.5">
    <a href="{{ route('public.leagues.index', array_filter([$param === 'city_id' ? null : 'city_id' => request('city_id'), $param === 'sport_id' ? null : 'sport_id' => request('sport_id')])) }}"
    ...
    @foreach($items as $item)
        <a href="{{ route('public.leagues.index', array_filter([
