                    ...
                    <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-xl hover:bg-gray-800/70 transition-colors">
                        ...
                        <div class="text-center mb-4">
                            <div class="text-xs text-gray-400 mb-1">
                                {{ $match->league->organization->name }} • {{ $match->league->name }}
                            </div>
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('public.matches.live', [$match->league, $match]) }}"
                            ...
                            <a href="{{ route('public.matches.show', [$match->league, $match]) }}"
