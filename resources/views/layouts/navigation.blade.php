<nav x-data="{ open: false }" class="bg-gray-800/50 backdrop-blur-xl border-b border-gray-700/50 shadow-2xl relative z-[70]">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3">
                        ...
                        <span class="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">MojTurnir</span>
                    </a>
                </div>
