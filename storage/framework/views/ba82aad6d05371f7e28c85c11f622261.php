...
<div class="space-y-8">
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white mt-1"><?php echo e(\App\Models\User::count()); ?></p>
                </div>
            ...
            <div class="mt-4">
                <div class="flex items-center text-sm">
                    <span class="text-green-400 font-medium">+<?php echo e(\App\Models\User::where('created_at', '>=', now()->subDays(30))->count()); ?></span>
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white mt-1"><?php echo e(\App\Models\Organization::count()); ?></p>
                </div>
            ...
            <div class="mt-4">
                <div class="flex items-center text-sm">
                    <span class="text-green-400 font-medium">+<?php echo e(\App\Models\Organization::where('created_at', '>=', now()->subDays(30))->count()); ?></span>
                    <span class="text-gray-500 ml-2">u zadnjih 30 dana</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white mt-1"><?php echo e(\App\Models\League::count()); ?></p>
                </div>
            ...
            <div class="mt-4">
                <div class="flex items-center text-sm">
                    <span class="text-green-400 font-medium">+<?php echo e(\App\Models\League::where('created_at', '>=', now()->subDays(30))->count()); ?></span>
                    <span class="text-gray-500 ml-2">u zadnjih 30 dana</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white mt-1"><?php echo e(\App\Models\Sport::active()->count()); ?></p>
                </div>
            ...
            <div class="mt-4">
                <div class="flex items-center text-sm">
                    <span class="text-gray-400">od <?php echo e(\App\Models\Sport::count()); ?> ukupno</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 p-3 rounded-lg bg-gray-700/30">
                    <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center self-start sm:self-center">
                        <span class="text-white font-bold text-sm"><?php echo e(substr($user->name, 0, 2)); ?></span>
                    </div>
                    <div class="flex-1">
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-xl">
            ...
            <div class="space-y-4">
                <?php $__currentLoopData = \App\Models\Organization::with('user')->latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $org): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 p-3 rounded-lg bg-gray-700/30">
                    <div class="w-10 h-10 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center self-start sm:self-center">
                        <span class="text-white font-bold text-sm"><?php echo e(substr($org->name, 0, 2)); ?></span>
                    </div>
                    <div class="flex-1">
                        <p class="text-white font-medium"><?php echo e($org->name); ?></p>
                        <p class="text-gray-400 text-sm">od <?php echo e($org->user->name); ?></p>
                    </div>
                    <div class="text-left sm:text-right">
                        <p class="text-gray-400 text-xs"><?php echo e($org->created_at->diffForHumans()); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
                ...
                <p class="text-gray-400"><?php echo e(app()->version()); ?></p>
            </div>
            <div class="text-center">
                ...
                <p class="text-gray-400"><?php echo e(PHP_VERSION); ?></p>
            </div>
            <div class="text-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ermin\Projekti\teamsphere\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>