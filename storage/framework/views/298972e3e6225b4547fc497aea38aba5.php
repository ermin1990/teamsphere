            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-10 py-4 rounded-xl text-white font-semibold text-lg transition-all">
                            Počni Besplatno
                        </a>
                    <?php endif; ?>
                    <?php if(Route::has('login')): ?>
                        <a href="<?php echo e(route('login')); ?>" class="border-2 border-gray-600 hover:border-gray-500 px-10 py-4 rounded-xl text-gray-300 hover:text-white font-semibold text-lg transition-all">
                            Prijavi se
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <!-- Live Matches Banner -->
                <div class="mt-16">
                    <a href="<?php echo e(route('public.live-matches')); ?>" class="block max-w-2xl mx-auto bg-gradient-to-r from-green-500/10 to-emerald-500/10 border-2 border-green-500/30 rounded-2xl p-8 hover:border-green-500/50 transition-all group">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="text-left">
                                    ...
                                    <div class="text-white text-2xl font-black">
                                        <?php if(isset($liveMatchesCount) && $liveMatchesCount > 0): ?>
                                            <?php echo e($liveMatchesCount); ?> <?php echo e($liveMatchesCount == 1 ? 'Meč u Toku' : ($liveMatchesCount < 5 ? 'Meča u Toku' : 'Mečeva u Toku')); ?>
...
<?php /**PATH C:\Users\ermin\Projekti\teamsphere\resources\views/welcome.blade.php ENDPATH**/ ?>