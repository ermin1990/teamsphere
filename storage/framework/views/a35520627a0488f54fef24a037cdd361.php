        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-xl">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <?php if($organization->user_id === Auth::id() && $organization->canCreateMoreLeagues()): ?>
                        <a href="<?php echo e(route('leagues.create', $organization)); ?>" class="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-4 py-2 rounded-xl transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-blue-500/25 inline-block">
                ...
                <?php if($organization->leagues->count() > 0): ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php $__currentLoopData = $organization->leagues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $league): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('leagues.show', $league)); ?>" class="bg-gray-700/30 rounded-xl p-4 hover:bg-gray-600/30 transition-all duration-200 transform hover:scale-[1.02] cursor-pointer block">
                                <div class="flex items-center space-x-3 mb-3">
                                    <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl flex items-center justify-center">
                                        <span class="text-white font-bold text-sm"><?php echo e(substr($league->name, 0, 2)); ?></span>
                                    </div>
                                    <div class="flex-1">
                                        <h4 class="text-white font-semibold"><?php echo e($league->name); ?></h4>
                                        <p class="text-gray-400 text-sm"><?php echo e($league->sport->name); ?></p>
                                    </div>
                                </div>
                                <div class="space-y-2">
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-400"><?php echo e($league->is_team_based ? 'Timovi' : 'Igrači'); ?>:</span>
                                        <span class="text-white"><?php echo e($league->teams->count()); ?></span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-400">Tip:</span>
                                        <span class="text-white"><?php echo e($league->is_team_based ? 'Tim' : 'Individualno'); ?></span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-400">Status:</span>
                                        <span class="
                                            <?php if($league->status === 'active'): ?> text-green-400
                                            <?php elseif($league->status === 'draft'): ?> text-yellow-400
                                            <?php elseif($league->status === 'completed'): ?> text-blue-400
                                            <?php else: ?> text-red-400 <?php endif; ?>">
                                            <?php echo e(ucfirst($league->status)); ?>
