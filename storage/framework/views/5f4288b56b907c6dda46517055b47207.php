...
<div class="mb-6 flex flex-wrap gap-3">
    ...
    <?php else: ?>
        ...
        <form method="POST" action="<?php echo e(route('organizations.competitions.reset', [$organization, $competition])); ?>" class="ml-auto" onsubmit="return confirm('Resetovati takmičenje na fabrička podešavanja? Svi mečevi, grupe i rezultati biće obrisani.');">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ermin\Projekti\teamsphere\resources\views/organizations/competitions/partials/actions-bar.blade.php ENDPATH**/ ?>