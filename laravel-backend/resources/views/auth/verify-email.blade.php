<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <p class="text-gray-400">Prije nego što nastavite, molimo vas da verifikujete svoju email adresu klikom na link koji smo vam poslali.</p>
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 p-4 bg-green-500/10 border border-green-500/20 rounded-xl">
            <p class="text-green-400 text-sm">Novi link za verifikaciju je poslan na vašu email adresu.</p>
        </div>
    @endif
